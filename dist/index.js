import de, { useState as q1, useEffect as tr, createContext as nr, cloneElement as C2, useContext as ir } from "react";
import { Modal as Oe, Popup as or } from "semantic-ui-react";
function sr(e) {
  if (e.sheet)
    return e.sheet;
...
}(), u1 = "-ms-", ce = "-moz-", $ = "-webkit-", Se = "comm", He = "rule", Ve = "decl", cr = "@import", L2 = "@keyframes", fr = Math.abs, pe = String.fromCharCode, ur = Object.assign;
function dr(e, r) {
...
function g1() {
  return s1 = L1 < v2 ? c1(G1, L1++) : 0, U1++, s1 === 10 && (U1 = 1, he++), s1;
}
function A1() {
  return c1(G1, L1);
}
...
function m2(e) {
  return he = U1 = 1, v2 = M1(G1 = e), L1 = 0, [];
}
function w2(e) {
  return G1 = "", e;
}
function ae(e) {
  return g2(K1(L1 - 1, Re(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function gr(e) {
  for (; (s1 = A1()) && s1 < 33; )
    g1();
  return J1(e) > 2 || J1(s1) > 3 ? "" : " ";
}
function vr(e, r) {
...
function xr(e) {
  return w2(le("", null, null, null, [""], e = m2(e), 0, [0], e));
}
function le(e, r, n, l, s, v, _, y, E) {
  for (var A = 0, k = 0, R = _, F = 0, J = 0, W = 0, T = 1, X = 1, G = 1, m = 0, f1 = "", b1 = s, d1 = v, K = l, D = f1; X; )
    switch (W = m, m = g1()) {
      case 40:
      ...
      case 0:
        switch (m) {
          ...
          case 125:
            X = 0;
          case 59 + k:
            J > 0 && M1(D) - R && te(J > 32 ? e2(D + ";", l, n, R - 1) : e2(Y(D, " ", "") + ";", l, n, R - 2), E);
            break;
          case 59:
            D += ";";
          default:
      ...
      default:
        ...
        switch (D += pe(m), m * T) {
          ...
          case 44:
            ...
            break;
          case 64:
            A1() === 45 && (D += ae(g1())), F = A1(), k = R = M1(f1 = D += wr(se())), m++;
            break;
          case 45:
            W === 45 && M1(D) == 2 && (T = 0);
        }
...
function Ke(e, r, n, l, s, v, _, y, E, A, k) {
  for (var R = s - 1, F = s === 0 ? v : [""], J = Te(F), W = 0, T = 0, X = 0; W < l; ++W)
    for (var G = 0, m = Q1(e, R + 1, R = fr(T = _[W])), f1 = e; G < J; ++G)
      (f1 = g2(T > 0 ? F[G] + " " + m : Y(m, /&\f/g, F[G]))) && (E[X++] = f1);
  return Ce(e, r, n, s === 0 ? He : y, E, A, k);
}
function _r(e, r, n) {
  return Ce(e, r, n, Se, pe(Cr()), Q1(e, 2, -2), 0);
}
function e2(e, r, n, l) {
...
var Mr = function(r, n, l) {
  for (var s = 0, v = 0; s = v, v = A1(), s === 38 && v === 12 && (n[l] = 1), !J1(v); )
    g1();
  return K1(r, L1);
}, Ar = function(r, n) {
  var l = -1, s = 44;
  do
    switch (J1(s)) {
      case 0:
        s === 38 && A1() === 12 && (n[l] = 1), r[l] += Mr(L1 - 1, n, l);
        break;
      case 2:
        r[l] += ae(s);
        break;
  ...
  return w2(Ar(m2(r), n));
}, r2 = /* @__PURE__ */ new WeakMap(), Nr = function(r) {
  if (!(r.type !== "rule" || !r.parent || r.length < 1)) {
    for (var n = r.value, l = r.parent, s = r.column === l.column && r.line === l.line; l.type !== "rule"; )
      if (l = l.parent, !l)
        return;
    if (!(r.props.length === 1 && n.charCodeAt(0) !== 58 && !r2.get(l)) && !s) {
      r2.set(r, !0);
      for (var v = [], _ = Or(n, v), y = l.props, E = 0, A = 0; E < _.length; E++)
...
}, Sr = "emotion-disable-server-rendering-unsafe-selector-warning-please-do-not-use-this-the-warning-exists-for-a-reason", Hr = function(r) {
    ...
    case 4765:
      if (M1(e) - 1 - r > 6)
        switch (c1(e, r + 1)) {
          ...
          case 115:
            return ~Ne(e, "stretch") ? _2(Y(e, "stretch", "fill-available"), r) + e : e;
        }
      break;
    case 4949:
      if (c1(e, r + 1) !== 115)
...
var Zr = function(r, n, l, s) {
  if (r.length > -1 && !r.return)
    switch (r.type) {
      case Ve:
        r.return = _2(r.value, r.length);
        break;
      case L2:
        return I1([z1(r, {
          value: Y(r.value, "@", "@" + $)
      ...
      case He:
        if (r.length)
          return hr(r.props, function(v) {
            switch (pr(v, /(::plac\w+|:read-\w+)/)) {
              case ":read-only":
              case ":read-write":
                return I1([z1(r, {
...
If multiple caches share the same key they might "fight" for each other's style elements.`);
  if (n === "css") {
    ...
    Array.prototype.forEach.call(l, function(T) {
      var X = T.getAttribute("data-emotion");
      X.indexOf(" ") !== -1 && (document.head.appendChild(T), T.setAttribute("data-s", ""));
    });
  }
  var s = r.stylisPlugins || Br;
  ...
  _ = r.container || document.head, Array.prototype.forEach.call(
    ...
    function(T) {
      for (var X = T.getAttribute("data-emotion").split(" "), G = 1; G < X.length; G++)
        v[X[G]] = !0;
      y.push(T);
    }
  );
  var E, A = [Nr, Rr];
  process.env.NODE_ENV !== "production" && A.push(Vr({
    get compat() {
      return W.compat;
    }
  }), Fr);
  {
    var k, R = [yr, process.env.NODE_ENV !== "production" ? function(T) {
      T.root || (T.return ? k.insert(T.return) : T.value && T.type !== Se && k.insert(T.value + "{}"));
    } : br(function(T) {
      k.insert(T);
    })], F = Er(A.concat(s, R)), J = function(X) {
      return I1(xr(X), F);
    };
    E = function(X, G, m, f1) {
      ...
      }), J(X ? X + "{" + G.styles + "}" : G.styles), f1 && (W.inserted[G.name] = !0);
    };
  }
  var W = {
    key: n,
...
var Ur = /[A-Z]|^ms/g, y2 = /_EMO_([^_]+?)_([^]*?)_EMO_/g, Fe = function(r) {
  return r.charCodeAt(1) === 45;
}, n2 = function(r) {
  return r != null && typeof r != "boolean";
}, _e = /* @__PURE__ */ kr(function(e) {
  return Fe(e) ? e : e.replace(Ur, "-$&").toLowerCase();
}), fe = function(r, n) {
  switch (r) {
    case "animation":
    case "animationName":
      if (typeof n == "string")
        return n.replace(y2, function(l, s, v) {
          return E1 = {
            name: s,
            styles: v,
            next: E1
  ...
  return Ir[r] !== 1 && !Fe(r) && typeof n == "number" && n !== 0 ? n + "px" : n;
};
if (process.env.NODE_ENV !== "production") {
  var Gr = /(var|attr|counters?|url|element|(((repeating-)?(linear|radial))|conic)-gradient)\(|(no-)?(open|close)-quote/, jr = ["normal", "none", "initial", "inherit", "unset"], zr = fe, Yn = /^-ms-/, qn = /-(.)/g, i2 = {};
  fe = function(r, n) {
    if (r === "content" && (typeof n != "string" || jr.indexOf(n) === -1 && !Gr.test(n) && (n.charAt(0) !== n.charAt(n.length - 1) || n.charAt(0) !== '"' && n.charAt(0) !== "'")))
      throw new Error("You seem to be using a value for 'content' without quotes, try replacing it with `content: '\"" + n + "\"'`");
    var l = zr(r, n);
    return l !== "" && !Fe(r) && r.indexOf("-") !== -1 && i2[r] === void 0 && (i2[r] = !0), l;
  };
}
var E2 = "Component selectors can only be used in conjunction with @emotion/babel-plugin, the swc Emotion plugin, or another Emotion-aware compiler transform.";
function X1(e, r, n) {
  if (n == null)
    return "";
  ...
  switch (typeof n) {
    ...
    case "string":
      if (process.env.NODE_ENV !== "production") {
        var y = [], E = n.replace(y2, function(k, R, F) {
          var J = "animation" + y.length;
          return y.push("const " + J + " = keyframes`" + F.replace(/^@keyframes animation-\w+/, "") + "`"), "${" + J + "}";
        });
        y.length;
      }
      break;
...
var o2 = /label:\s*([^\s;\n{]+)\s*(;|$)/g, b2;
process.env.NODE_ENV !== "production" && (b2 = /\/\*#\ssourceMappingURL=data:application\/json;\S+\s+\*\//g);
var E1, ye = function(r, n, l) {
  ...
  E1 = void 0;
  var _ = r[0];
  _ == null || _.raw === void 0 ? (s = !1, v += X1(l, n, _)) : (process.env.NODE_ENV !== "production" && _[0], v += _[0]);
  for (var y = 1; y < r.length; y++)
    v += X1(l, n, r[y]), s && (process.env.NODE_ENV !== "production" && _[y], v += _[y]);
  var E;
  process.env.NODE_ENV !== "production" && (v = v.replace(b2, function(F) {
    return E = F, "";
  })), o2.lastIndex = 0;
  for (var A = "", k; (k = o2.exec(v)) !== null; )
    A += "-" + k[1];
  var R = Pr(v) + A;
...
var Yr = function(r, n, l) {
  var s = r.key + "-" + n.name;
  (l === !1 || Wr === !1) && r.registered[s] === void 0 && (r.registered[s] = n.styles);
}, qr = function(r, n, l) {
  Yr(r, n, l);
  var s = r.key + "-" + n.name;
...
var Qr = function(r) {
  ...
  return {
    ...
    sheet: n.sheet,
    cache: n,
    getRegisteredStyles: k2.bind(null, n.registered),
    merge: a2.bind(null, n.registered, l)
  };
}, Jr = function e(r) {
  ...
  key: "css"
}), M2 = Ze.cx, Xr = Ze.keyframes, O1 = Ze.css;
const Kr = "_btn_vihvp_1", et = "_primary_vihvp_25", rt = "_loading_vihvp_36", tt = "_disabled_vihvp_43", nt = "_large_vihvp_46", it = "_medium_vihvp_49", ot = "_small_vihvp_52", Z1 = {
  btn: Kr,
...
function lt() {
  ...
  function _(y, E, A) {
    var k, R = {}, F = null, J = null;
    A !== void 0 && (F = "" + A), E.key !== void 0 && (F = "" + E.key), E.ref !== void 0 && (J = E.ref);
    for (k in E)
      l.call(E, k) && !v.hasOwnProperty(k) && (R[k] = E[k]);
    if (y && y.defaultProps)
      for (k in E = y.defaultProps, E)
        R[k] === void 0 && (R[k] = E[k]);
    return { $$typeof: r, type: y, key: F, ref: J, props: R, _owner: s.current };
  }
...
function ct() {
  return c2 || (c2 = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function c(a) {
      return !!(typeof a == "string" || typeof a == "function" || a === l || a === v || i || a === s || a === A || a === k || D || a === J || b1 || d1 || K || typeof a == "object" && a !== null && (a.$$typeof === F || a.$$typeof === R || a.$$typeof === _ || a.$$typeof === y || a.$$typeof === E || a.$$typeof === o || a.getModuleId !== void 0));
    }
    function C(a, x, M) {
      var H = a.displayName;
      if (H)
...
` + Z[n1].replace(" at new ", " at ");
      ...
      var D1 = a ? a.displayName || a.name : "", Xe = D1 ? N1(D1) : "";
      return typeof a == "function" && H1.set(a, Xe), Xe;
    }
    function h1(a, x, M) {
      return V1(a, !1);
    }
    ...
    function Ge(a) {
      if (D2(a))
        return m("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", B2(a)), Ue(a);
    }
    var j1 = G.ReactCurrentOwner, P2 = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function W2(a, x, M, H, z) {
      {
        var Q, U = {}, Z = null, p1 = null;
        M !== void 0 && (Ge(M), Z = "" + M), U2(x) && (Ge(x.key), Z = "" + x.key), I2(x) && (p1 = x.ref, G2(x, z));
        for (Q in x)
          ee.call(x, Q) && !P2.hasOwnProperty(Q) && (U[Q] = x[Q]);
        if (a && a.defaultProps) {
        ...
        if (Z || p1) {
          ...
          Z && j2(U, o1), p1 && z2(U, o1);
        }
        return $2(a, Z, p1, z, H, j1.current, U);
      }
    }
...
Check the top-level render call using <` + M + ">.");
    ...
    var er = K2, rr = X2;
    W1.Fragment = l, W1.jsx = er, W1.jsxs = rr;
  }()), W1;
}
(function(e) {
...
function Be({
  ...
  const F = {
    ...
    medium: Z1.medium,
    small: Z1.small
  }, J = `${Z1.btn} ${e ? Z1.primary : Z1.default} ${n ? F[n] : ""} ${v ? Z1.loading : ""} ${s}`, W = l || "button";
...
N.WalletEx = B(jt);
N.TopUp = B(zt);
const $t = "_content_vpu82_1", Wt = "_install_vpu82_5", f2 = {
  content: $t,
  install: Wt
};
function Yt({
  ...
  return /* @__PURE__ */ b(ue, {
    children: [/* @__PURE__ */ b("div", {
      className: `sk-t-center ${f2.content}`,
...
const qt = "_modal_16onz_1", Qt = "_mini_16onz_5", Jt = "_small_16onz_8", Xt = "_content_16onz_12", Kt = "_box_16onz_17", en = "_close_16onz_31", ne = {
  modal: qt,
  mini: Qt,
  small: Jt,
  content: Xt,
...
`, O2 = O1`
  ...
  border-radius: 2px;
  animation: ${rn} 1s forwards linear infinite;
`, tn = O1`
  display: flex;
...
const on = "_modal_17r40_1", sn = "_browser_17r40_7", u2 = {
  modal: on,
  browser: sn
...
function De({
  ...
  const A = `sk-t-center ${u2.modal}`, [k, R] = q1(E), [F, J] = q1("mini"), [W, T] = q1(A);
  return tr(() => {
    E || (xn ? s ? (T(A), R(/* @__PURE__ */ t(R2, {
      ...{
        name: e,
        logo: r,
        loading: l,
    ...
    }))) : (J("tiny"), T(`${A} ${u2.browser}`), R(/* @__PURE__ */ t(fn, {}))));
  }, [E, s, l]), /* @__PURE__ */ t(nn, {
    open: n,
    onClose: y,
    closeIcon: !0,
...
De.Connecting = N2;
De.Address = R2;
var _n = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, ke = Math.ceil, k1 = Math.floor, C1 = "[BigNumber Error] ", d2 = C1 + "Number primitive has more than 15 significant digits: ", y1 = 1e14, V = 14, Me = 9007199254740991, Ae = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], T1 = 1e7, a1 = 1e9;
function S2(e) {
  var r, n, l, s = m.prototype = { constructor: m, toString: null, valueOf: null }, v = new m(1), _ = 20, y = 4, E = -7, A = 21, k = -1e7, R = 1e7, F = !1, J = 1, W = 0, T = {
    prefix: "",
    groupSize: 3,
    ...
    suffix: ""
  }, X = "0123456789abcdefghijklmnopqrstuvwxyz", G = !0;
  function m(i, o) {
    ...
    if (o == null) {
      ...
      if (r1(o, 2, X.length, "Base"), o == 10 && G)
      ...
      if (L = String(i), f = typeof i == "number") {
        ...
        h.s = L.charCodeAt(0) === 45 ? (L = L.slice(1), -1) : 1;
      for (c = X.slice(0, o), p = g = 0, d = L.length; g < d; g++)
  ...
  m.clone = S2, m.ROUND_UP = 0, m.ROUND_DOWN = 1, m.ROUND_CEIL = 2, m.ROUND_FLOOR = 3, m.ROUND_HALF_UP = 4, m.ROUND_HALF_DOWN = 5, m.ROUND_HALF_EVEN = 6, m.ROUND_HALF_CEIL = 7, m.ROUND_HALF_FLOOR = 8, m.EUCLID = 9, m.config = m.set = function(i) {
    var o, c;
    if (i != null)
      if (typeof i == "object") {
        ...
        if (i.hasOwnProperty(o = "MODULO_MODE") && (c = i[o], r1(c, 0, 9, o), J = c), i.hasOwnProperty(o = "POW_PRECISION") && (c = i[o], r1(c, 0, a1, o), W = c), i.hasOwnProperty(o = "FORMAT"))
    ...
    return function(c, C, u, p, g) {
      ...
      for (e1 >= 0 && (h = W, W = 0, c = c.replace(".", ""), P = new m(C), O = P.pow(c.length - e1), W = h, P.c = o(
        ...
        u,
        i
      ), P.e = P.c.length), S = o(c, C, u, g ? (f = X, i) : (f = i, X)), L = h = S.length; S[--h] == 0; S.pop())
        ;
      if (!S[0])
        return f.charAt(0);
  ...
  return s.absoluteValue = s.abs = function() {
    ...
    var c, C, u = this;
    return i = new m(i, o), !u.c || !i.s || i.c && !i.c[0] ? new m(NaN) : !i.c || u.c && !u.c[0] ? new m(u) : (J == 9 ? (C = i.s, i.s = 1, c = r(u, i, 0, 3), i.s = C, c.s *= C) : c = r(u, i, 0, J), i = u.minus(c.times(i)), !i.c[0] && J == 1 && (i.s = u.s), i);
    ...
    return u === null ? C ? (o = "Infinity", C < 0 && (o = "-" + o)) : o = "NaN" : (i == null ? o = u <= E || u >= A ? oe(w1(c.c), u) : S1(w1(c.c), u, "0") : i === 10 && G ? (c = K(new m(c), _ + u + 1, y), o = S1(w1(c.c), c.e, "0")) : (r1(i, 2, X.length, "Base"), o = n(S1(w1(c.c), u, "0"), 10, i, C, !0)), C < 0 && c.c[0] && (o = "-" + o)), o;
...
const Mn = "_button_16oo9_1", An = "_text_16oo9_11", On = "_pending_16oo9_23", p2 = {
  button: Mn,
  text: An,
  pending: On
};
  ...
  return /* @__PURE__ */ t("div", {
    ...
    children: /* @__PURE__ */ b("div", {
      ...
      children: [l && /* @__PURE__ */ t(N.Pending, {
        className: `rotate-center-linear-infinite ${p2.pending}`
      }), e]
    })
  });
}
...
function Jn({
  ...
  return n || (n = () => l), /* @__PURE__ */ t(V2.Provider, {
    value: {
      activedIndex: l,
      setActivedIndex: s,
      onChange: n
    ...
    children: /* @__PURE__ */ t("div", {
      ...
      children: r.map((v, _) => C2(v, {
        _index: _
      }))
    })
  });
}
const Sn = "_tab_49sii_1", Hn = "_actived_49sii_5", h2 = {
  tab: Sn,
  actived: Hn
};
function Xn({
  ...
  return /* @__PURE__ */ t("div", {
    className: `sk-tab ${h2.tab}`,
    onClick: s,
    children: /* @__PURE__ */ t("span", {
      className: `sk-t-h4 sk-c-n50 ${l.activedIndex === r && `actived ${h2.actived}`}`,
      children: e
    })
  }, n);
}
