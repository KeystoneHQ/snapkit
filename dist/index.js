import Me, { useState as ue, useEffect as Tr, createContext as Rr, cloneElement as Zt, useContext as Fr } from "react";
...
var r1 = (e, t) => !!~e.indexOf(t), G = (e, t = "-") => e.join(t), qe = (e, t) => G(e.filter(Boolean), t), z = (e, t = 1) => e.slice(t), Pr = (e) => e, Pt = () => {
}, V1 = (e) => e[0].toUpperCase() + z(e), tt = (e) => e.replace(/[A-Z]/g, "-$&").toLowerCase(), q1 = (e, t) => {
...
}, e) : e, $t = typeof CSS < "u" && CSS.escape || ((e) => e.replace(/[!"'`*+.,;:\\/<=>?@#$%&^|~()[\]{}]/g, "\\$&").replace(/^\d/, "\\3$& ")), Se = (e) => (Array.isArray(e) || (e = [e]), "@media " + G(e.map((t) => (typeof t == "string" && (t = { min: t }), t.raw || G(Object.keys(t).map((r) => `(${r}-width:${t[r]})`), " and "))), ",")), Be = (e) => {
  ...
  return a;
}, B1, re, $1 = (e = "") => (B1.push(e), ""), nt = (e) => {
  B1.length = Math.max(B1.lastIndexOf("") + ~~e, 0);
...
`:
  ...
  if (!t) {
    ...
    t = e.map((s, h) => {
      ...
      const k = [...B1];
      return re = [], (_) => {
        re.push(...w), B1 = [...k], _ && Ee(_);
      };
    }), xt.set(e, t);
  }
  return t;
}, Xe = (e) => (B1 = [], re = [], Array.isArray(e[0]) && Array.isArray(e[0].raw) ? zr(e[0]).forEach((t, r) => t(e[r + 1])) : Ee(e), re), Je, Gr = (e, t) => (typeof t == "function" && (Je = !1), t), Wr = (e) => {
  Je = !0;
  ...
  if (t.length)
    return t;
}, Qe = /* @__PURE__ */ Yt(_e), Xr = (e, t) => e + (t[1] == ":" ? z(t, 2) + ":" : z(t)) + ":", _t = (e, t = e.d) => typeof t == "function" ? "" : e.v.reduce(Xr, "") + (e.i ? "!" : "") + (e.n ? "-" : "") + t, b, Y1, X, Ce = (e) => e == "cols" ? "columns" : "rows", pe = (e) => (t, r, a) => ({
  [e]: a + ((b = G(t)) && "-" + b)
}), a1 = (e, t) => (r, a, s) => (b = G(r, t)) && {
  [e || s]: b
}, C1 = (e) => (t, { theme: r }, a) => (b = r(e || a, t)) && {
  [e || a]: b
}, ve = (e, t) => (r, { theme: a }, s) => (b = a(e || s, r, G(r, t))) && {
  [e || s]: b
}, S1 = (e, t) => (r, a) => e(r, a, t), R1 = pe("display"), ie = pe("position"), K1 = pe("textTransform"), ee = pe("textDecoration"), Le = pe("fontStyle"), P1 = (e) => (t, r, a) => ({
  ["--tw-" + e]: a,
  fontVariantNumeric: "var(--tw-ordinal,/*!*/ /*!*/) var(--tw-slashed-zero,/*!*/ /*!*/) var(--tw-numeric-figure,/*!*/ /*!*/) var(--tw-numeric-spacing,/*!*/ /*!*/) var(--tw-numeric-fraction,/*!*/ /*!*/)"
}), we = (e, { theme: t }, r) => (b = t("inset", e)) && { [r]: b }, fe = (e, t, r, a = r) => (b = t(a + "Opacity", z(e))) && {
  [`--tw-${r}-opacity`]: b
}, De = (e, t) => Math.round(parseInt(e, 16) * t), Ae = (e, t, r) => e && e[0] == "#" && (b = (e.length - 1) / 3) && (X = [17, 1, 0.062272][b - 1]) ? `rgba(${De(e.substr(1, b), X)},${De(e.substr(1 + b, b), X)},${De(e.substr(1 + 2 * b, b), X)},${t ? `var(--tw-${t}${r ? "," + r : ""})` : r || 1})` : e, ke = (e, t, r) => r && typeof r == "string" ? (b = Ae(r, t + "-opacity")) && b !== r ? {
  [`--tw-${t}-opacity`]: "1",
  [e]: [r, b]
  ...
  [X]: "0",
  [qe([s, b[0], h])]: (Y1 = t(a, z(e))) && `calc(${Y1} * var(${X}))`,
  [qe([s, b[1], h])]: Y1 && [Y1, `calc(${Y1} * calc(1 - var(${X})))`]
} : void 0, qt = (e, t) => t[0] && {
  [e]: (r1("wun", (t[0] || "")[3]) ? "space-" : "") + t[0]
}, Ze = (e) => (t) => r1(["start", "end"], t[0]) ? { [e]: "flex-" + t[0] } : qt(e, t), At = (e) => (t, { theme: r }) => {
  if (b = r("grid" + V1(e), t, ""))
    return { ["grid-" + e]: b };
  switch (t[0]) {
    case "span":
    ...
    case "start":
    case "end":
      return (b = r("grid" + V1(e) + V1(t[0]), z(t), G(z(t)))) && {
        [`grid-${e}-${t[0]}`]: b
      };
  }
}, Mt = (e, { theme: t }, r) => {
...
}, Ke = (e) => (e ? "translate3d(var(--tw-translate-x,0),var(--tw-translate-y,0),0)" : "translateX(var(--tw-translate-x,0)) translateY(var(--tw-translate-y,0))") + " rotate(var(--tw-rotate,0)) skewX(var(--tw-skew-x,0)) skewY(var(--tw-skew-y,0)) scaleX(var(--tw-scale-x,1)) scaleY(var(--tw-scale-y,1))", Pe = (e, t, r) => e[0] && (b = t.theme(r, e[1] || e[0])) && {
  [`--tw-${r}-x`]: e[0] !== "y" && b,
  [`--tw-${r}-y`]: e[0] !== "x" && b,
  ...
  return X = e.shift(), r1(["hue", "drop"], X) && (X += V1(e.shift())), (b = t(s ? "backdrop" + V1(X) : X, e)) && {
  ...
  contents: R1,
  flow: R1,
  table: (e, t, r) => r1(["auto", "fixed"], e[0]) ? { tableLayout: e[0] } : R1(e, t, r),
  flex(e, t, r) {
    switch (e[0]) {
      case "row":
      case "col":
      ...
      case "grow":
      case "shrink":
        return b = t.theme("flex" + V1(e[0]), z(e), e[1] || 1), b != null && {
          ["flex-" + e[0]]: "" + b
        };
    }
    return (b = t.theme("flex", e, "")) ? { flex: b } : R1(e, t, r);
  },
  grid(e, t, r) {
    switch (e[0]) {
      case "cols":
      case "rows":
        return (b = t.theme("gridTemplate" + V1(Ce(e[0])), z(e), e.length == 2 && Number(e[1]) ? `repeat(${e[1]},minmax(0,1fr))` : G(z(e)))) && {
  ...
  auto: (e, { theme: t }) => r1(["cols", "rows"], e[0]) && (b = t("gridAuto" + V1(Ce(e[0])), z(e), G(z(e)))) && {
    ["gridAuto-" + Ce(e[0])]: b
  },
  static: ie,
  fixed: ie,
  ...
  bottom: we,
  left: we,
  inset: (e, { theme: t }) => (b = _e(e[0])) ? Qe(t("inset", z(e)), e[0]) : (b = t("inset", e)) && {
    top: b,
    right: b,
    bottom: b,
    left: b
  ...
  italic: Le,
  "not-italic": S1(Le, "normal"),
  "font-italic": S1(Le, "italic"),
  "font-not-italic": S1(Le, "normal"),
  ...
  "justify-self": a1(),
  "justify-items": a1(),
  justify: Ze("justifyContent"),
  content: Ze("alignContent"),
  self: Ze("alignSelf"),
  place: (e) => e[0] && qt("place-" + e[0], z(e)),
  overscroll: (e) => e[0] && {
  ...
  ordinal: P1("ordinal"),
  "slashed-zero": P1("slashed-zero"),
  "lining-nums": P1("numeric-figure"),
  "oldstyle-nums": P1("numeric-figure"),
  "proportional-nums": P1("numeric-spacing"),
  "tabular-nums": P1("numeric-spacing"),
  "diagonal-fractions": P1("numeric-fraction"),
  "stacked-fractions": P1("numeric-fraction"),
  ...
  border: (e, t, r) => _e(e[0]) ? Qe(t.theme("borderWidth", z(e)), e[0], "border", "width") : Mt(e, t, r),
  ...
  object: (e, t, r) => r1(["contain", "cover", "fill", "none", "scale-down"], G(e)) ? { objectFit: G(e) } : ve("objectPosition", " ")(e, t, r),
  list: (e, t, r) => G(e) == "item" ? R1(e, t, r) : r1(["inside", "outside"], G(e)) ? { listStylePosition: e[0] } : ve("listStyleType")(e, t, r),
  rounded: (e, t, r) => qr(t.theme("borderRadius", z(e), ""), e[0], "border", "radius") || C1("borderRadius")(e, t, r),
  ...
  throw new Error(e);
}), i2 = /* @__PURE__ */ it(Pt), N1 = (e, t, r) => `${e}:${t}${r ? " !important" : ""}`, o2 = (e, t, r) => {
  let a = "";
  const s = Br(e);
  s && (a += `${N1(s, t, r)};`);
  let h = Dr(e);
  return h & 1 && (a += `-webkit-${N1(e, t, r)};`), h & 2 && (a += `-moz-${N1(e, t, r)};`), h & 4 && (a += `-ms-${N1(e, t, r)};`), h = Zr(e, t), h & 1 && (a += `${N1(e, `-webkit-${t}`, r)};`), h & 2 && (a += `${N1(e, `-moz-${t}`, r)};`), h & 4 && (a += `${N1(e, `-ms-${t}`, r)};`), a += N1(e, t, r), a;
}, oe = (e, t) => {
  const r = {};
  do
    for (let a = 1; a < e; a++)
  ...
  const h = [...r, a];
  t[G(h)] = s, t[G(h, ".")] = s, s && typeof s == "object" && Jt(s, t, h);
}, t), t), a2 = {
  negative: () => ({}),
...
}, se, Qt = /^:(group(?:(?!-focus).+?)*)-(.+)$/, Kt = /^(:not)-(.+)/, er = (e) => e[1] == "[" ? z(e) : e, u2 = (e, t, { theme: r, tag: a }) => {
  const s = (h, w) => (se = r("screens", z(w), "")) ? { [Se(se)]: h } : w == ":dark" && e == "class" ? { ".dark &": h } : (se = Qt.exec(w)) ? { [`.${$t(a(se[1]))}:${se[2]} &`]: h } : {
    [t[z(w)] || "&" + w.replace(Kt, (k, _, T) => _ + "(" + er(":" + T) + ")")]: h
  };
  return (h, w) => w.v.reduceRight(s, h);
}, L1, tr = (e) => (((L1 = /(?:^|min-width: *)(\d+(?:.\d+)?)(p)?/.exec(e)) ? +L1[1] / (L1[2] ? 15 : 1) / 10 : 0) & 31) << 22, rr = (e) => {
  L1 = 0;
  ...
  "tiona",
  "quire"
], p2 = (e) => 1 << (~(L1 = d2.indexOf(e.replace(Qt, ":$2").slice(3, 8))) ? L1 : 17), h2 = (e, t) => (r, a) => r | ((L1 = e("screens", z(a), "")) ? 1 << 27 | tr(Se(L1)) : a == ":dark" ? 1 << 30 : (L1 = t[a] || a.replace(Kt, ":$2"))[0] == "@" ? nr(L1) : p2(a)), g2 = (e) => e[0] == "-" ? 0 : rr(e) + ((L1 = /^(?:(border-(?!w|c|sty)|[tlbr].{2,4}m?$|c.{7}$)|([fl].{5}l|g.{8}$|pl))/.exec(e)) ? +!!L1[1] || -!!L1[2] : 0) + 1, Ue = (e, t) => t + "{" + e + "}", C2 = (e, t, r) => {
  ...
  const T = (F, B, q, j, i1) => {
    ...
    let u1 = "", d1 = 0, m = 0;
    j["@apply"] && (j = rt(q1(Wt(j["@apply"]), r), { ...j, "@apply": void 0 }, r)), Object.keys(j).forEach((I) => {
      const l1 = q1(j[I], r);
      if (It(I, l1)) {
        if (l1 !== "" && I.length > 1) {
          const p1 = tt(I);
        ...
        if (I == ":global" && (I = "@global"), I[0] == "@")
          if (I[1] == "g")
            ...
            _.push({
              r: Ue(G(K.map((A) => A.r), ""), I),
              p: K.reduce((A, n) => A + n.p, 0)
            });
          } else
            I[1] == "i" ? (Array.isArray(l1) ? l1 : [l1]).forEach((p1) => p1 && _.push({ p: 0, r: `${I} ${p1};` })) : (I[2] == "c" && (I = Se(r.theme("screens", z(I, 8).trim()))), T([...F, I], B, q | tr(I) | nr(I), l1, i1));
        else
          T(F, B ? B.replace(/ *((?:\(.+?\)|\[.+?\]|[^,])+) *(,|$)/g, (p1, K, A) => I.replace(/ *((?:\(.+?\)|\[.+?\]|[^,])+) *(,|$)/g, (n, o, l) => (r1(o, "&") ? o.replace(/&/g, K) : (K && K + " ") + o) + l) + A) : I, q, l1, i1);
    }), m && _.push({
      r: F.reduceRight(Ue, Ue(u1, B)),
      p: q * (1 << 8) + ((Math.max(0, 15 - m) & 15) << 4 | (d1 || 15) & 15)
    });
  }, V = h2(a, t);
  return (F, B, q, j = 0) => (j <<= 28, _ = [], T([], B ? "." + $t(B) : "", q ? q.v.reduceRight(V, j) : j, F, q && q.i), _);
}, v2 = (e, t, r, a) => {
  let s;
  r((w = []) => s = w);
  let h;
...
}, Ie = (e, t, r, a = t) => e === !1 ? r : e === !0 ? a : e || t, L2 = (e) => (typeof e == "string" ? { t: n2, a: Ht, i: i2 }[e[1]] : e) || Ht, w2 = { _: { value: "", writable: !0 } }, m2 = (e = {}) => {
  const t = c2(e.theme), r = L2(e.mode), a = Ie(e.hash, !1, !1, Be), s = e.important;
  let h = { v: [] }, w = 0;
  const k = [], _ = {
    tw: (...A) => p1(A),
    theme: (A, n, o) => {
  ...
  }, F = { ...Kr, ...e.variants }, B = u2(e.darkMode || "media", F, _), q = C2(Ie(e.prefix, o2, N1), F, _), j = e.sheet || (typeof window > "u" ? r2() : t2(e)), { init: i1 = (A) => A() } = j, u1 = v2(j, r, i1, _);
  let d1;
  i1((A = /* @__PURE__ */ new Map()) => d1 = A);
  const m = /* @__PURE__ */ new WeakMap(), I = (A, n) => A == "_" ? void 0 : typeof n == "function" ? JSON.stringify(q1(n, _), I) : n, l1 = (A) => {
    !w && h.v.length && (A = { ...A, v: [...h.v, ...A.v], $: "" }), A.$ || (A.$ = _t(A, m.get(A.d)));
    let n = w ? null : d1.get(A.$);
    if (n == null) {
      let o = V(A);
      if (A.$ || (A.$ = Be(JSON.stringify(o, I)), m.set(A.d, A.$), A.$ = _t(A, A.$)), o && typeof o == "object")
        if (A.v = A.v.map(er), s && (A.i = s), o = B(o, A), w)
          k.push(o);
        else {
          const l = typeof A.d == "function" ? typeof o._ == "string" ? 1 : 3 : 2;
          n = a || typeof A.d == "function" ? (a || Be)(l + A.$) : A.$, q(o, n, A, l).forEach(u1), o._ && (n += " " + o._);
        }
      else
    ...
    return n;
  }, p1 = (A) => G(Xe(A).map(l1).filter(Boolean), " "), K = Ie(e.preflight, Pr, !1);
  if (K) {
...
const H2 = "_btn_vihvp_1", T2 = "_primary_vihvp_25", R2 = "_loading_vihvp_36", F2 = "_disabled_vihvp_43", N2 = "_large_vihvp_46", V2 = "_medium_vihvp_49", B2 = "_small_vihvp_52", W1 = {
  btn: H2,
...
function U2() {
  return Rt || (Rt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function I(c, y, M) {
      {
        var R = d1.ReactDebugCurrentFrame, Y = R.getStackAddendum();
        Y !== "" && (y += "%s", M = M.concat([Y]));
    ...
    var L = Object.assign, f = 0, d, v, C, x, S, H, P;
    function e1() {
    }
    ...
    function o1() {
      {
        if (f === 0) {
          d = console.log, v = console.info, C = console.warn, x = console.error, S = console.group, H = console.groupCollapsed, P = console.groupEnd;
          var c = {
            configurable: !0,
            enumerable: !0,
            value: e1,
    ...
    var W = d1.ReactCurrentDispatcher, c1;
    function H1(c, y, M) {
      {
        if (c1 === void 0)
          try {
...
` + c1 + c;
    ...
    function Z1(c, y) {
      ...
      try {
        ...
        if (T1 && R && typeof T1.stack == "string") {
          for (var D = T1.stack.split(`
`), v1 = R.stack.split(`
...
` + D[s1].replace(" at new ", " at ");
                    return c.displayName && y1.includes("<anonymous>") && (y1 = y1.replace("<anonymous>", c.displayName)), typeof c == "function" && D1.set(c, y1), y1;
                  }
                while (s1 >= 1 && f1 >= 0);
              break;
            }
        ...
        j1 = !1, W.current = Q, U(), Error.prepareStackTrace = Y;
      }
      var Q1 = c ? c.displayName || c.name : "", mt = Q1 ? H1(Q1) : "";
      return typeof c == "function" && D1.set(c, mt), mt;
    }
    function w1(c, y, M) {
      return Z1(c, !1);
    }
    ...
    function dr(c, y, M, R, Y) {
      {
        ...
        for (var $ in c)
          if (Q(c, $)) {
            ...
            D && !(D instanceof Error) && (ge(Y), m("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", R || "React class", M, $, typeof D), ge(null)), D instanceof Error && !(D.message in lt) && (lt[D.message] = !0, ge(Y), m("Failed %s type: %s", M, D.message), ge(null));
          }
      }
    }
    ...
    function wr(c, y) {
      if (typeof c.ref == "string" && ne.current && y && ne.current.stateNode !== y) {
        ...
        Re[M] || (m('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', p(ne.current.type), c.ref), Re[M] = !0);
      }
    }
    function mr(c, y) {
      {
    ...
    function yr(c, y, M, R, Y) {
      {
        var Q, $ = {}, D = null, v1 = null;
        M !== void 0 && (ut(M), D = "" + M), Lr(y) && (ut(y.key), D = "" + y.key), vr(y) && (v1 = y.ref, wr(y, Y));
        for (Q in y)
          he.call(y, Q) && !Cr.hasOwnProperty(Q) && ($[Q] = y[Q]);
        if (c && c.defaultProps) {
        ...
        return xr(c, D, v1, Y, R, ne.current, $);
      }
    }
...
Check the top-level render call using <` + M + ">.");
    ...
    function vt(c, y) {
      {
        ...
        Ct[M] = !0;
        var R = "";
        c && c._owner && c._owner !== Fe.current && (R = " It was passed a child from " + p(c._owner.type) + "."), J1(c), m('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', M, R), J1(null);
      }
    }
    function Lt(c, y) {
      {
    ...
    function wt(c, y, M, R, Y, Q) {
      {
        ...
        if (!$) {
          ...
          v1 ? D += v1 : D += gt();
          var s1;
          c === null ? s1 = "null" : Te(c) ? s1 = "array" : c !== void 0 && c.$$typeof === t ? (s1 = "<" + (p(c.type) || "Unknown") + " />", D = " Did you accidentally export a JSX literal instead of a component?") : s1 = typeof c, m("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s1, D);
        }
        var f1 = yr(c, y, M, Y, Q);
        if (f1 == null)
          return f1;
    ...
    var Or = Sr, Hr = Mr;
    le.Fragment = a, le.jsx = Or, le.jsxs = Hr;
  }()), le;
}
(function(e) {
  process.env.NODE_ENV === "production" ? e.exports = P2() : e.exports = U2();
})(He);
const sr = He.exports.Fragment, i = He.exports.jsx, E = He.exports.jsxs;
function I2() {
  return /* @__PURE__ */ i("div", {
    className: Z2["line-wobble"]
  });
}
function st({
  primary: e,
  ...
  const B = {
    ...
    medium: W1.medium,
    small: W1.small
  }, q = `${W1.btn} ${e ? W1.primary : W1.default} ${r ? B[r] : ""} ${h ? W1.loading : ""} ${s}`, j = a || "button";
  return Me.createElement(j, {
    className: q,
    disabled: t,
    onClick: () => {
      h || V && V();
    ...
    ...F
  }, h ? w || /* @__PURE__ */ i(I2, {}) : /* @__PURE__ */ E("div", {
    className: X1(or`
          display: flex;
          padding: 0 8px;
...
O.WalletEx = Z(x0);
O.TopUp = Z(y0);
const _0 = "_content_vpu82_1", k0 = "_install_vpu82_5", Ft = {
  content: _0,
  install: k0
};
function E0({
...
const A0 = "_modal_16onz_1", M0 = "_mini_16onz_5", S0 = "_small_16onz_8", O0 = "_content_16onz_12", H0 = "_box_16onz_17", T0 = "_close_16onz_31", be = {
  modal: A0,
  mini: M0,
  small: S0,
  content: O0,
...
const F0 = "_modal_17r40_1", N0 = "_browser_17r40_7", Nt = {
  modal: F0,
  browser: N0
}, V0 = "_browsers_17xer_1", B0 = "_msg_17xer_7", D0 = "_desc_17xer_11", $e = {
  browsers: V0,
  msg: B0,
  desc: D0
};
...
const P0 = "_connect_5hpcy_1", U0 = "_logos_5hpcy_5", I0 = "_logo_5hpcy_5", $0 = "_help_5hpcy_17", j0 = "_btn_5hpcy_21", z0 = "_pulse_5hpcy_1", E1 = {
  connect: P0,
  logos: U0,
  logo: I0,
  help: $0,
...
const G0 = "_connect_1vrf6_1", W0 = "_help_1vrf6_12", Y0 = "_btn_1vrf6_16", je = {
  connect: G0,
  help: W0,
  btn: Y0
};
...
const X0 = q0(navigator.userAgent);
function at({
  name: e,
  logo: t,
  open: r,
  ...
  const T = `sk-t-center ${Nt.modal}`, [V, F] = ue(_), [B, q] = ue("mini"), [j, i1] = ue(T);
  return Tr(() => {
    _ || (X0 ? s ? (i1(T), F(/* @__PURE__ */ i(cr, {
      ...{
        name: e,
        logo: t,
        loading: a,
    ...
    }))) : (q("tiny"), i1(`${T} ${Nt.browser}`), F(/* @__PURE__ */ i(Z0, {}))));
  }, [_, s, a]), /* @__PURE__ */ i(R0, {
    open: r,
    onClose: k,
    closeIcon: !0,
...
at.Connecting = lr;
at.Address = cr;
var J0 = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, ze = Math.ceil, O1 = Math.floor, b1 = "[BigNumber Error] ", Vt = b1 + "Number primitive has more than 15 significant digits: ", M1 = 1e14, N = 14, Ge = 9007199254740991, We = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], I1 = 1e7, h1 = 1e9;
function fr(e) {
  ...
  function m(n, o) {
    ...
    if (o == null) {
      ...
      if (v = String(n), f = typeof n == "number") {
        ...
        C.s = v.charCodeAt(0) === 45 ? (v = v.slice(1), -1) : 1;
      for (l = u1.slice(0, o), p = L = 0, d = v.length; L < d; L++)
        if (l.indexOf(g = v.charAt(L)) < 0) {
          ...
          } else if (!u && (v == v.toUpperCase() && (v = v.toLowerCase()) || v == v.toLowerCase() && (v = v.toUpperCase()))) {
            u = !0, L = -1, p = 0;
            continue;
          }
    ...
    for (L = 0; v.charCodeAt(L) === 48; L++)
      ;
    for (d = v.length; v.charCodeAt(--d) === 48; )
      ;
    if (v = v.slice(L, ++d)) {
      if (d -= L, f && m.DEBUG && d > 15 && (n > Ge || n !== O1(n)))
        throw Error(Vt + C.s * n);
      if ((p = p - L - 1) > F)
        C.c = C.e = null;
      else if (p < V)
        C.c = [C.e = 0];
      else {
        if (C.e = p, C.c = [], L = (p + 1) % N, p < 0 && (L += N), L < d) {
          for (L && C.c.push(+v.slice(0, L)), d -= N; L < d; )
  ...
  m.clone = fr, m.ROUND_UP = 0, m.ROUND_DOWN = 1, m.ROUND_CEIL = 2, m.ROUND_FLOOR = 3, m.ROUND_HALF_UP = 4, m.ROUND_HALF_DOWN = 5, m.ROUND_HALF_EVEN = 6, m.ROUND_HALF_CEIL = 7, m.ROUND_HALF_FLOOR = 8, m.EUCLID = 9, m.config = m.set = function(n) {
    ...
    return function(l) {
      var g, u, p, L, f, d = 0, v = [], C = new m(h);
      if (l == null ? l = w : n1(l, 0, h1), L = ze(l / N), B)
        if (crypto.getRandomValues) {
          for (g = crypto.getRandomValues(new Uint32Array(L *= 2)); d < L; )
            f = g[d] * 131072 + (g[d + 1] >>> 11), f >= 9e15 ? (u = crypto.getRandomValues(new Uint32Array(2)), g[d] = u[0], g[d + 1] = u[1]) : (v.push(f % 1e14), d += 2);
          d = L / 2;
        } else if (crypto.randomBytes) {
          for (g = crypto.randomBytes(L *= 7); d < L; )
            f = (g[d] & 31) * 281474976710656 + g[d + 1] * 1099511627776 + g[d + 2] * 4294967296 + g[d + 3] * 16777216 + (g[d + 4] << 16) + (g[d + 5] << 8) + g[d + 6], f >= 9e15 ? crypto.randomBytes(7).copy(g, d) : (v.push(f % 1e14), d += 7);
          d = L / 7;
        } else
          throw B = !1, Error(b1 + "crypto unavailable");
      if (!B)
        for (; d < L; )
          f = o(), f < 9e15 && (v[d++] = f % 1e14);
      for (L = v[--d], l %= N, L && l && (f = We[N - l], v[d] = O1(L / f) * f); v[d] === 0; v.pop(), d--)
        ;
      if (d < 0)
        v = [p = 0];
      else {
    ...
    var n = "0123456789";
    function o(l, g, u, p) {
      for (var L, f = [0], d, v = 0, C = l.length; v < C; ) {
        for (d = f.length; d--; f[d] *= g)
          ;
        for (f[0] += p.indexOf(l.charAt(v++)), L = 0; L < f.length; L++)
          f[L] > u - 1 && (f[L + 1] == null && (f[L + 1] = 0), f[L + 1] += f[L] / u | 0, f[L] %= u);
      }
      return f.reverse();
    }
    return function(l, g, u, p, L) {
      var f, d, v, C, x, S, H, P, e1 = l.indexOf("."), o1 = w, U = k;
      for (e1 >= 0 && (C = j, j = 0, l = l.replace(".", ""), P = new m(g), S = P.pow(l.length - e1), j = C, P.c = o(
        F1(_1(S.c), S.e, "0"),
        10,
        u,
        n
      ), P.e = P.c.length), H = o(l, g, u, L ? (f = u1, n) : (f = n, u1)), v = C = H.length; H[--C] == 0; H.pop())
        ;
      if (!H[0])
        return f.charAt(0);
      if (e1 < 0 ? --v : (S.c = H, S.e = v, S.s = p, S = t(S, P, o1, U, u), H = S.c, x = S.r, v = S.e), d = v + o1 + 1, e1 = H[d], C = u / 2, x = x || d < 0 || H[d + 1] != null, x = U < 4 ? (e1 != null || x) && (U == 0 || U == (S.s < 0 ? 3 : 2)) : e1 > C || e1 == C && (U == 4 || x || U == 6 && H[d - 1] & 1 || U == (S.s < 0 ? 8 : 7)), d < 1 || !H[0])
        l = x ? F1(f.charAt(1), -o1, f.charAt(0)) : f.charAt(0);
      else {
        if (H.length = d, x)
          for (--u; ++H[--d] > u; )
            H[d] = 0, d || (++v, H = [1].concat(H));
        for (C = H.length; !H[--C]; )
          ;
    ...
    function n(g, u, p) {
      var L, f, d, v, C = 0, x = g.length, S = u % I1, H = u / I1 | 0;
      for (g = g.slice(); x--; )
        d = g[x] % I1, v = g[x] / I1 | 0, L = H * d + v * S, f = S * d + L % I1 * I1 + C, C = (f / p | 0) + (L / I1 | 0) + H * v, g[x] = f % p;
    ...
    function l(g, u, p, L) {
      for (var f = 0; p--; )
        g[p] -= f, f = g[p] < u[p] ? 1 : 0, g[p] = f * L + g[p] - u[p];
      for (; !g[0] && g.length > 1; g.splice(0, 1))
        ;
    }
    return function(g, u, p, L, f) {
      var d, v, C, x, S, H, P, e1, o1, U, W, c1, H1, j1, D1, x1, Z1, w1 = g.s == u.s ? 1 : -1, g1 = g.c, J = u.c;
      if (!g1 || !g1[0] || !J || !J[0])
        return new m(
          !g.s || !u.s || (g1 ? J && g1[0] == J[0] : !J) ? NaN : g1 && g1[0] == 0 || !J ? w1 * 0 : w1 / 0
        );
      for (e1 = new m(w1), o1 = e1.c = [], v = g.e - u.e, w1 = p + v + 1, f || (f = M1, v = k1(g.e / N) - k1(u.e / N), w1 = w1 / N | 0), C = 0; J[C] == (g1[C] || 0); C++)
        ;
      if (J[C] > (g1[C] || 0) && v--, w1 < 0)
        o1.push(1), x = !0;
      else {
        for (j1 = g1.length, x1 = J.length, C = 0, w1 += 2, S = O1(f / (J[0] + 1)), S > 1 && (J = n(J, S, f), g1 = n(g1, S, f), x1 = J.length, j1 = g1.length), H1 = x1, U = g1.slice(0, x1), W = U.length; W < x1; U[W++] = 0)
          ;
        Z1 = J.slice(), Z1 = [0].concat(Z1), D1 = J[0], J[1] >= f / 2 && D1++;
        do {
          if (S = 0, d = o(J, U, x1, W), d < 0) {
            if (c1 = U[0], x1 != W && (c1 = c1 * f + (U[1] || 0)), S = O1(c1 / D1), S > 1)
              for (S >= f && (S = f - 1), H = n(J, S, f), P = H.length, W = U.length; o(H, U, P, W) == 1; )
                S--, l(H, x1 < P ? Z1 : J, P, f), P = H.length, d = 1;
            else
              S == 0 && (d = S = 1), H = J.slice(), P = H.length;
            if (P < W && (H = [0].concat(H)), l(U, H, W, f), W = U.length, d == -1)
              for (; o(J, U, x1, W) < 1; )
                S++, l(U, x1 < W ? Z1 : J, W, f), W = U.length;
          } else
            d === 0 && (S++, U = [0]);
          o1[C++] = S, U[0] ? U[W++] = g1[H1] || 0 : (U = [g1[H1]], W = 1);
        } while ((H1++ < j1 || U[0] != null) && w1--);
  ...
  function I(n, o, l, g) {
    ...
    if (l == null ? l = k : n1(l, 0, 8), !n.c)
      return n.toString();
    if (u = n.c[0], L = n.e, o == null)
      d = _1(n.c), d = g == 1 || g == 2 && (L <= _ || L >= T) ? ye(d, L) : F1(d, L, "0");
    else if (n = K(new m(n), o, l), p = n.e, d = _1(n.c), f = d.length, g == 1 || g == 2 && (o <= p || p <= _)) {
      for (; f < o; d += "0", f++)
        ;
      d = ye(d, p);
    } else if (o -= L, d = F1(d, p, "0"), p + 1 > f) {
      if (--o > 0)
        for (d += "."; o--; d += "0")
          ;
    } else if (o += p - f, o > 0)
  ...
  a = function() {
    ...
    return function(p, L, f, d) {
      var v, C = f ? L : L.replace(u, "");
      if (g.test(C))
        p.s = isNaN(C) ? null : C < 0 ? -1 : 1;
      else {
        if (!f && (C = C.replace(n, function(x, S, H) {
          return v = (H = H.toLowerCase()) == "x" ? 16 : H == "b" ? 2 : 8, !d || d == v ? S : x;
        }), d && (v = d, C = C.replace(o, "$1").replace(l, "0.$1")), L != C))
          return new m(C, v);
        if (m.DEBUG)
          throw Error(b1 + "Not a" + (d ? " base " + d : "") + " number: " + L);
        p.s = null;
      }
      p.c = p.e = null;
    };
  ...
  function K(n, o, l, g) {
    var u, p, L, f, d, v, C, x = n.c, S = We;
    if (x) {
      e: {
        for (u = 1, f = x[0]; f >= 10; f /= 10, u++)
          ;
        if (p = o - u, p < 0)
          p += N, L = o, d = x[v = 0], C = d / S[u - L - 1] % 10 | 0;
        else if (v = ze((p + 1) / N), v >= x.length)
          if (g) {
            for (; x.length <= v; x.push(0))
              ;
            d = C = 0, u = 1, p %= N, L = p - N + 1;
          } else
            break e;
        else {
          for (d = f = x[v], u = 1; f >= 10; f /= 10, u++)
            ;
          p %= N, L = p - N + u, C = L < 0 ? 0 : d / S[u - L - 1] % 10 | 0;
        }
        if (g = g || o < 0 || x[v + 1] != null || (L < 0 ? d : d % S[u - L - 1]), g = l < 4 ? (C || g) && (l == 0 || l == (n.s < 0 ? 3 : 2)) : C > 5 || C == 5 && (l == 4 || g || l == 6 && (p > 0 ? L > 0 ? d / S[u - L] : 0 : x[v - 1]) % 10 & 1 || l == (n.s < 0 ? 8 : 7)), o < 1 || !x[0])
          return x.length = 0, g ? (o -= n.e + 1, x[0] = S[(N - o % N) % N], n.e = -o || 0) : x[0] = n.e = 0, n;
        if (p == 0 ? (x.length = v, f = 1, v--) : (x.length = v + 1, f = S[N - p], x[v] = L > 0 ? O1(d / S[u - L] % S[L]) * f : 0), g)
          for (; ; )
            if (v == 0) {
  ...
  function A(n) {
    var o, l = n.e;
    return l === null ? n.toString() : (o = _1(n.c), o = l <= _ || l >= T ? ye(o, l) : F1(o, l, "0"), n.s < 0 ? "-" + o : o);
  }
  return s.absoluteValue = s.abs = function() {
    ...
    for (f ? (l = new m(0.5), d && (n.s = 1), v = xe(n)) : (u = Math.abs(+A(n)), v = u % 2), C = new m(h); ; ) {
      if (v) {
        if (C = C.times(x), !C.c)
          break;
    ...
    return g ? C : (d && (C = h.div(C)), o ? C.mod(o) : p ? K(C, j, k, L) : C);
    ...
    var l, g, u, p, L = this, f = L.s;
    if (n = new m(n, o), o = n.s, !f || !o)
      return new m(NaN);
    if (f != o)
      return n.s = -o, L.plus(n);
    var d = L.e / N, v = n.e / N, C = L.c, x = n.c;
    if (!d || !v) {
      if (!C || !x)
    ...
    if (d = k1(d), v = k1(v), C = C.slice(), f = d - v) {
      for ((p = f < 0) ? (f = -f, u = C) : (v = d, u = x), u.reverse(), o = f; o--; u.push(0))
        ;
      u.reverse();
    } else
    ...
    var l, g, u, p, L, f, d, v, C, x, S, H, P, e1, o1, U = this, W = U.c, c1 = (n = new m(n, o)).c;
    if (!W || !c1 || !W[0] || !c1[0])
      return !U.s || !n.s || W && !W[0] && !c1 || c1 && !c1[0] && !W ? n.c = n.e = n.s = null : (n.s *= U.s, !W || !c1 ? n.c = n.e = null : (n.c = [0], n.e = 0)), n;
    for (g = k1(U.e / N) + k1(n.e / N), n.s *= U.s, d = W.length, x = c1.length, d < x && (P = W, W = c1, c1 = P, u = d, d = x, x = u), u = d + x, P = []; u--; P.push(0))
      ;
    for (e1 = M1, o1 = I1, u = x; --u >= 0; ) {
      for (l = 0, S = c1[u] % o1, H = c1[u] / o1 | 0, L = d, p = u + L; p > u; )
    ...
    var p = g.e / N, L = n.e / N, f = g.c, d = n.c;
    if (!p || !L) {
      if (!f || !d)
        return new m(u / 0);
      if (!f[0] || !d[0])
    ...
    if (p = k1(p), L = k1(L), f = f.slice(), u = p - L) {
      for (u > 0 ? (L = p, l = d) : (u = -u, l = f), l.reverse(); u--; l.push(0))
        ;
      l.reverse();
    }
    for (u = f.length, o = d.length, u - o < 0 && (l = d, d = f, f = l, o = u), u = 0; o; )
      u = (f[--o] = f[o] + d[o] + u) / M1 | 0, f[o] = M1 === f[o] ? 0 : f[o] % M1;
    return u && (f = [u].concat(f), ++L), p1(n, f, L);
    ...
    var n, o, l, g, u, p = this, L = p.c, f = p.s, d = p.e, v = w + 4, C = new m("0.5");
    if (f !== 1 || !L || !L[0])
      return new m(!f || f < 0 && (!L || L[0]) ? NaN : L ? p : 1 / 0);
    if (f = Math.sqrt(+A(p)), f == 0 || f == 1 / 0 ? (o = _1(L), (o.length + d) % 2 == 0 && (o += "0"), f = Math.sqrt(+o), d = k1((d + 1) / 2) - (d < 0 || d % 2), f == 1 / 0 ? o = "5e" + d : (o = f.toExponential(), o = o.slice(0, o.indexOf("e") + 1) + d), l = new m(o)) : l = new m(f + ""), l.c[0]) {
      for (d = l.e, f = d + v, f < 3 && (f = 0); ; )
        if (u = l, l = C.times(u.plus(t(p, u, v, 1))), _1(u.c).slice(0, f) === (o = _1(l.c)).slice(0, f))
    ...
    if (g = u.toFixed(n, o), u.c) {
      var p, L = g.split("."), f = +l.groupSize, d = +l.secondaryGroupSize, v = l.groupSeparator || "", C = L[0], x = L[1], S = u.s < 0, H = S ? C.slice(1) : C, P = H.length;
      if (d && (p = f, f = d, d = p, P -= p), f > 0 && P > 0) {
        for (p = P % f || f, C = H.substr(0, p); p < P; p += f)
          C += v + H.substr(p, f);
        d > 0 && (C += v + H.slice(p)), S && (C = "-" + C);
      }
    ...
    var o, l, g, u, p, L, f, d, v, C, x, S, H = this, P = H.c;
    if (n != null && (f = new m(n), !f.isInteger() && (f.c || f.s !== 1) || f.lt(h)))
      throw Error(b1 + "Argument " + (f.isInteger() ? "out of range: " : "not an integer: ") + A(f));
    if (!P)
      return new m(H);
    for (o = new m(h), v = l = new m(h), g = d = new m(h), S = _1(P), p = o.e = S.length - H.e - 1, o.c[0] = We[(L = p % N) < 0 ? N + L : L], n = !n || f.comparedTo(o) > 0 ? p > 0 ? o : v : f, L = F, F = 1 / 0, f = new m(S), d.c[0] = 0; C = t(f, o, 0, 1), u = l.plus(C.times(g)), u.comparedTo(n) != 1; )
      l = g, g = u, v = d.plus(C.times(u = v)), d = u, o = f.minus(C.times(u = o)), f = u;
    return u = t(n.minus(l), g, 0, 1), d = d.plus(u.times(v)), l = l.plus(u.times(g)), d.s = v.s = H.s, p = p * 2, x = t(v, g, p, k).minus(H).abs().comparedTo(
      t(d, l, p, k).minus(H).abs()
    ) < 1 ? [v, g] : [d, l], F = L, x;
  }, s.toNumber = function() {
    return +A(this);
    ...
    return u === null ? g ? (o = "Infinity", g < 0 && (o = "-" + o)) : o = "NaN" : (n == null ? o = u <= _ || u >= T ? ye(_1(l.c), u) : F1(_1(l.c), u, "0") : n === 10 && d1 ? (l = K(new m(l), w + u + 1, k), o = F1(_1(l.c), l.e, "0")) : (n1(n, 2, u1.length, "Base"), o = r(F1(_1(l.c), u, "0"), 10, n, g, !0)), g < 0 && l.c[0] && (o = "-" + o)), o;
...
var Q0 = fr();
const K0 = "_balance_1phiq_1", en = "_suffix_1phiq_6", tn = {
  balance: K0,
  suffix: en
};
function xn({
  ...
  return /* @__PURE__ */ E("div", {
    ...
    children: [/* @__PURE__ */ i("span", {
      ...
      className: `sk-c-n50 sk-t-h4 ${tn.suffix}`,
      children: "USD"
    })]
  });
}
const rn = "_button_16oo9_1", nn = "_text_16oo9_11", on = "_pending_16oo9_23", Bt = {
  button: rn,
  text: nn,
  pending: on
};
...
function yn({
  ...
  return r || (r = () => a), /* @__PURE__ */ i(ur.Provider, {
    ...
    children: /* @__PURE__ */ i("div", {
      className: `sk-tabs ${ln.container}`,
      children: t.map((h, w) => Zt(h, {
        _index: w
      }))
    })
  });
}
const cn = "_tab_49sii_1", fn = "_actived_49sii_5", Dt = {
  tab: cn,
  actived: fn
};
function _n({
  ...
  return /* @__PURE__ */ i("div", {
    className: `sk-tab ${Dt.tab}`,
    onClick: s,
    children: /* @__PURE__ */ i("span", {
      className: `sk-t-h4 sk-c-n50 ${a.activedIndex === t && `actived ${Dt.actived}`}`,
      children: e
    })
  }, r);
}
const un = "_container_1o9qt_1", dn = "_body_1o9qt_6", pn = "_left_1o9qt_10", hn = "_right_1o9qt_15", gn = "_rightBottom_1o9qt_20", ce = {
  container: un,
  body: dn,
  left: pn,
  right: hn,
